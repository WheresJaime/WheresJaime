...
from libs.oauthlib.common import Request, urlencode, generate_nonce
from libs.oauthlib.common import generate_timestamp, to_unicode
...
class Client(object):
  ...
  def get_oauth_params(self, request):
    ...
    if request.body is not None and content_type_eligible:
      params.append(
        ('oauth_body_hash', base64.b64encode(hashlib.sha1(request.body.encode('utf-8')).digest()).decode('utf-8')))
