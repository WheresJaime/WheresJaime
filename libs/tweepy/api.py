...
from libs.tweepy import ModelParser, Parser
from libs.tweepy import TweepError
from libs.tweepy import list_to_csv
from libs.tweepy.binder import bind_api
...
class API(object):
  ...
  def update_status(self, *args, **kwargs):
    ...
    return bind_api(
      ...
      method='POST',
      payload_type='status',
      allowed_param=['status', 'in_reply_to_status_id', 'in_reply_to_status_id_str', 'auto_populate_reply_metadata',
                     'lat', 'long', 'source', 'place_id', 'display_coordinates'],
      require_auth=True
  ...
  def send_direct_message(self, recipient_id, text, quick_reply_type=None, attachment_type=None,
